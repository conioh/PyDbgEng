...
This is a modified version of pydbgeng that removes the dependency on
the compiled proxy library.  It also updates the library to work with
newer versions of comtypes and Python.
